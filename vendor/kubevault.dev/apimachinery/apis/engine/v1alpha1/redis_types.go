...
// +kubebuilder:resource:path=redisroles,singular=redisrole,categories={vault,appscode,all}
...
type RedisRoleSpec struct {
	...
	//	- https://developer.hashicorp.com/vault/api-docs/secret/databases/redis
